...
<head>
    ...
    <title>NTBK Store Tasikmalaya - PENJUALAN MINGGU/BULAN {{ $tanggal_awal1 }} SAMPAI {{ $tanggal_akhir1 }}</title>
    <style>
        body {
            font-size: 12px;
        }
...
<body win>
    ...
    <section class="section3">
        <table>
            ...
            @endforeach
            <tr>
                <td colspan="8" align="center"><strong>TOTAL PENDAPATAN</strong> </td> <td>
