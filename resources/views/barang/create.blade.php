                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="is_jasa" id="is_jasa" class="form-control form-control-sm">
                                                <option value="0" {{ old('is_jasa') == '0' ? 'selected' : '' }}>Barang Fisik</option>
                                                <option value="1" {{ old('is_jasa') == '1' ? 'selected' : '' }}>Jasa / Servis</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
...
<script>
    ...
    $('#is_jasa').on('change', function() {
        if ($(this).val() == '1') {
            ...
            $('#stok').attr('required', true).val('');
            $('#stok_minimal').attr('required', true).val('');
        }
    });
